...
agent_knowledge: {agent_knowledge} use this knowledge to generate more interesting and creative songs.
</context>
...
Please create happy engaging music prompt that is amazing for dj section on youtube video. 
</goal>
...
{{
    ...
    "vocalGender": "f", #Available genders: f or none
